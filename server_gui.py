...
if __name__ == '__main__':
    ...
    test_list.appendRow([QStandardItem('test_name'), QStandardItem('192.168.0.1'), QStandardItem('80')])
    application.active_clients_table.setModel(test_list)
    application.active_clients_table.resizeColumnsToContents()
